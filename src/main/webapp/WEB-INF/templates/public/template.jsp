...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/publicUrl/js/jquery-2.1.1.min.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/publicUrl/js/script.js"></script>
