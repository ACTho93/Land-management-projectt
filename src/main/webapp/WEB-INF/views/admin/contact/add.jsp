	  				...
	  				<div class="col-md-12 panel-info">
			  			...
			  			<div class="content-box-large box-with-header">
				  			<div>
								...
								<form action="${pageContext.request.contextPath}/admin/contact/add" method="post">
								<div class="row">
									<div class="col-sm-6">
										...
										<div class="form-group">
											...
											<input id="email" name="email" type="text" class="form-control" placeholder="Nhập email">
											<form:errors cssStyle="color: red"  path="user.password"></form:errors>
										</div>
										<div class="form-group">
											<label for="subject">Subject</label>
											<input id="subject" name="subject" type="text" class="form-control" placeholder="Nhập subject">
											<form:errors cssStyle="color: red"  path="user.fullname"></form:errors>
										</div>
										<div class="col-sm-12">
